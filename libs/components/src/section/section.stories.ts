  ...
  render: () => ({
    template: /*html*/ `
      ...
      <bit-section-header>
        ...
        <button type="button" bitIconButton="bwi-refresh" label="Refresh" size="small"></button>
      </bit-section-header>
    `,
  }),
};
  ...
  render: () => ({
    template: /*html*/ `
      ...
      <bit-section-header>
        ...
        <button type="button" bitIconButton="bwi-star" size="small" label="Favorite" slot="end"></button>
      </bit-section-header>
    `,
  }),
};
      ...
      <div class="tw-bg-background-alt tw-p-2">
        ...
        <bit-section>
          <bit-section-header>
            ...
            <button type="button" bitIconButton="bwi-star" size="small" slot="end" label="Favorite"></button>
          </bit-section-header>
          <bit-item>
